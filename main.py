...
# Notes on sending a POST request on POSTMAN:
# url: http://127.0.0.1:5000/add
# navigate to Body, select "x-www-form-urlencoded", then enter all params
...
def patch_new_price(cafe_id):
    ...
    if cafe:
        ...
        return jsonify(error={"Not Found": "Sorry no cafe with the entered ID found in the database."}), 404
